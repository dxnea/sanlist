...
import { getImageUrl, formatPrice, getUnitStep, isEditableElement } from '../utils/formatters';
...
export const ProductCard = memo((props: ProductCardProps) => {
  ...
  const displayPrice = product.price !== null ? formatPrice(product.price) : '—';
    ...
    >
      ...
      <div className="product-card-body">
        ...
        <div className="product-card-meta">
          ...
          <span className="product-card-unit">за {product.unit}</span>
        </div>
